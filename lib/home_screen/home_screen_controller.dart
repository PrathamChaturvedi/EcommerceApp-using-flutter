...
import 'package:shop_app/home_screen/model_class/banner_data_model.dart';
...
class HomeScreenController extends GetxController {
  ...
  late List<CategoriesModel> AgraData;
  bool isLoading = true;
  ...
  Future<void> getAgraData() async {
    await _firestore.collection('Agra ').get().then((value) {
      AgraData =
          value.docs.map((e) => CategoriesModel.fromJson(e.data())).toList();
    });
  }
