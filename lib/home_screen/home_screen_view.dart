...
import 'package:shop_app/home_screen/model_class/categories_model.dart';
import 'package:shop_app/home_screen/drawer.dart';
import 'package:shop_app/home_screen/home_screen_controller.dart';
import 'package:shop_app/categories_and_featured_screen/categories_and_featured_screen.dart';
import 'package:shop_app/items_screen/items_screen.dart';
                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        children: [
                          ...
                          categoriesTitle(size, "Agra", () {
                            Get.to(() => CategoriesAndFeaturedScreen(
                                  model: controller.AgraData,
                                ));
                          }),

                          listViewBuilder(size, controller.AgraData),
                        ],
                      ),
                    ),
                  ),
